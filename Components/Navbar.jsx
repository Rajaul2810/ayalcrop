        ...
        <nav className="bg-gray-800">
                    ...
                    <div className="flex items-center mx-auto">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex justify-center items-baseline space-x-4">
                                ...
                                <Link href="/whyUs" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Why Us</Link>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <Link href="/whyUs" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Why Us</Link>
